...
{
    public class ItemTabControlPages
    {
        ...
        public ItemTabControlPages(TabControl tabControl, CategoryManagement categoryManagement)
        {
        ...
        {
            return _categoryManagement.Categories.Count;
        }
        ...
        private void InitialAllTabPages(TabControl tabControl)
        {
            ...
            {
                TabPage tabPage = new TabPage(_categoryManagement.Categories[i].CategoryName);
        ...
        // 新增每個Item的button
        private void AddItemButton(TableLayoutPanel tableLayoutPanel)
        {
            int tag = 0;
